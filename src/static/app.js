          ...
          ? `<div class="participants">
               ...
               <ul>
                 ${details.participants
                   .map(
                     (email) =>
                       `<li><span>${email}</span><button class="participant-delete" data-activity="${encodeURIComponent(
                         name
                       )}" data-email="${encodeURIComponent(email)}" title="Unregister ${email}">✕</button></li>`
                   )
                   .join("")}
               </ul>
             </div>`
